...
- วันที่              -> document_date (แปลงเป็น YYYY-MM-DD)
  ⚠️ วันที่บนเอกสารเขียนแบบ วัน/เดือน/ปี (DD/MM/YYYY) เสมอ ห้ามอ่านเป็น เดือน/วัน
     เช่น "10/09/2026" = 10 กันยายน → "2026-09-10" (ไม่ใช่ "2026-10-09")
     "17/09/2026" → "2026-09-17" ; ถ้าเป็นปี พ.ศ. (เช่น 2569) ให้ลบ 543 เป็น ค.ศ.
